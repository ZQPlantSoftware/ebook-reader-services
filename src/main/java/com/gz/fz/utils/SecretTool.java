...
public class SecretTool {
     ...
     * 默认构造方法，使用默认密钥 
     */  
    public SecretTool() throws Exception {  
        this(strDefaultKey);  
    }  
    /** 
     * 指定密钥构造方法 
     ...
     * @throws Exception 
     */  
    public SecretTool(String strKey) throws Exception {  
    ...
    public static void main(String[] args) {  
        try {  
            String test2 = "{bid:4,probation:100,uid:1} ";  
            SecretTool des2 = new SecretTool("epubReader!@#8989");// 自定义密钥  
